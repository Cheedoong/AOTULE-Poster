...
%\begin{itemize}
	%\item Computing resource saved\\
		\includegraphics[width=0.49\linewidth]{fig/comp-saved-overtime-vs-ver-iter.eps}
		%\includegraphics[width=0.44\linewidth]{fig/comp-saved-overtime-vs-vseg.eps}
	%\item Improvement of QoE\\
		\includegraphics[width=0.49\linewidth]{fig/redirection-cmp.eps}
		\includegraphics[width=0.49\linewidth]{fig/startup-delay.eps}
		\includegraphics[width=0.49\linewidth]{fig/redirection-ver-cmp.eps}
	%\item Mismatch\\
		\includegraphics[width=0.56\linewidth]{fig/mismatch-overtime.pdf}
